      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex justify-center space-x-4 mb-12">
          <button
            ...
            className={`px-6 py-3 rounded-lg transition-all duration-300 ${activeTab === 'marketplace'
          ...
          <button
            ...
            className={`px-6 py-3 rounded-lg transition-all duration-300 ${activeTab === 'designer'
                ? 'bg-[#1A237E] text-white'
                : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
              } !rounded-button whitespace-nowrap`}
          >
              ...
              <div className="flex space-x-4 overflow-x-auto pb-4">
                {categories.map((category) => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-lg flex items-center space-x-2 transition-all duration-300 whitespace-nowrap ${selectedCategory === category.id
                        ? 'bg-[#1A237E] text-white'
                        : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                      } !rounded-button`}
                  >
